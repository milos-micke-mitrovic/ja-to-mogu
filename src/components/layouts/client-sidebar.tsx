...
export function ClientSidebar({ user }: ClientSidebarProps) {
  ...
  const navItems = [
    { href: '/dashboard', icon: LayoutDashboard, label: tDashboard('clientDashboard') },
    { href: '/packages', icon: Package, label: t('packages') },
    { href: '/journey', icon: MapPin, label: tDashboard('journey') },
    { href: '/history', icon: History, label: tDashboard('bookingHistory') },
